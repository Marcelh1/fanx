...
#define CHILD_ID_INDOOR_TEMP        7
#define CHILD_ID_OUTDOOR_TEMP       8
...
MyMessage msgSupplyFLOW(CHILD_ID_SUPPLY_FLOW, V_FLOW);
MyMessage msgExhaustFLOW(CHILD_ID_EXHAUST_FLOW, V_FLOW);
...
void presentation()
{
  ...
  present(CHILD_ID_SUPPLY_FLOW, S_GAS, "Supply flow (m3/h)");
  present(CHILD_ID_EXHAUST_FLOW, S_GAS, "Exhaust flow (m3/h)");
}
